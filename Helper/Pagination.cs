...
namespace Helper
{
    ...
    public class Pagination
    {
        ...
        private string  _firstLink       = "&lsaquo;&lsaquo;";
        private string  _nextLink        = "&gt;";
        private string  _prevLink        = "&lt;";
        private string  _lastLink        = "&rsaquo;&rsaquo;";

        #endregion

        #region Tag Properties

        private string  _fullTagOpen     = "<ul class=\"pagination\">";
        private string  _fullTagClose    = "</ul>";
        private string  _firstTagOpen    = "<li>";
        private string  _firstTagClose   = "</li>";
        private string  _lastTagOpen     = "<li>";
        private string  _lastTagClose    = "</li>";
        private string  _curTagOpen      = "<li class=\"active\"><a href=\"#\">";
        private string  _curTagClose     = "</a></li>";
        private string  _nextTagOpen     = "<li>";
        private string  _nextTagClose    = "</li>";
        private string  _prevTagOpen     = "<li>";
        private string  _prevTagClose    = "</li>";
        private string  _numTagOpen      = "<li>";
        private string  _numTagClose     = "</li>";
        private string  _itemTagOpen     = "<li>";
        private string  _itemTagClose    = "</li>";
        ...
        public string GetPageLinks(PaginationType pageType)
        {
            ...
            if (!this.BaseUrl.Trim().EndsWith("&page="))
