...
namespace MotorReservas.Entidad.Exceptions.Exceptions
{
    public class ModeloException : Exception
    {
        ...
        public ModeloException(params object[] pParams)
        ...
        public ModeloException(string pMensaje, Exception pInnerException)
            : base(pMensaje, pInnerException)
        {
        }

        protected ModeloException(SerializationInfo pInfo, StreamingContext pContext)
            : base(pInfo, pContext)
        {
        }
        ...
        public ModeloException(string pError)
            : base(pError)
        { 
